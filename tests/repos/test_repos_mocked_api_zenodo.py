...
class TestZenodoMethods(unittest.TestCase):
    ...
    def test_upload_file(self):
        ...
        filepath = "app/static/img/zenodo.png"
    ...
    @unittest.skip("currently failing at removing depositions, need to look into")
    ...
    # @unittest.skipIf(api_key is None, "no api key were given")
    @unittest.skip("currently failing at removing deposition, need to look into")
